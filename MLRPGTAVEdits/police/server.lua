...
RegisterServerEvent('police:getid')
AddEventHandler('police:getid', function(netID)
    ...
    TriggerClientEvent("police:getid", source, tostring(result[1].prenom.." "..result[1].nom), tostring(result[1].money), tostring(result[1].dirtymoney), tostring(result[1].job))
end)

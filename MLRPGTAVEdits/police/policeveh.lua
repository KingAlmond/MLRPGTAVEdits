--Modified for MLRP by KingAlmond
...
local policeveh = {
	...
	menu = {
		...
		["main"] = {
			...
			name = "main",
			buttons = {
				{name = "Trooper Taraus", costs = 0, description = {}, model = "police4"},
				{name = "Trooper Charger", costs = 0, description = {}, model = "police2"},
				{name = "Police Interceptor", costs = 0, description = {}, model = "police3"},
				{name = "UC Charger", costs = 0, description = {}, model = "fbi"},
				{name = "UC Tahoe", costs = 0, description = {}, model = "fbi2"},
				{name = "Trooper Bike", costs = 0, description = {}, model = "policeb"},
